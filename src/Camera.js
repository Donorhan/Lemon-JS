...
{
    var yawQuat     = quat.fromValues(0.0, 0.0, 0.0, 1.0);
    var pitchQuat   = quat.fromValues(0.0, 0.0, 0.0, 1.0);
    
    quat.setAxisAngle(yaw, [0.0, 1.0, 0.0], yawQuat);
    quat.setAxisAngle(-pitch, [1.0, 0.0, 0.0], pitchQuat);
 ...
 *
 * @return {!vec3} A vector with four values: x, y, w and h
 */
